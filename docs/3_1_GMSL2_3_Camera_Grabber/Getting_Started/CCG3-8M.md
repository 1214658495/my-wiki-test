...
<div style={{textAlign: 'center', marginBottom: '2rem'}}>
  <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/3_1_GMSL2_3_Camera_Grabber/CCG3-8M/CCG3-8M_Diagram.png" alt="CCG3-8M Block Diagram" style={{maxWidth: '80%', height:'auto', borderRadius: '8px'}} />
</div>
