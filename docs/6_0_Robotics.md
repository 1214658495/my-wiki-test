...
### <span style={{color: 'var(--ifm-color-primary)'}}>Astra S56C </span>
**Astra S56C** is the current recommended model in the Astra S56x series. It is a stereo camera designed for embodied AI applications, featuring dual 5MP global shutter sensors with a 60mm human-like baseline.
...
:::note Astra S56x series
The Astra S56x series includes S56 and S56C. S56 is a legacy 130° HFOV model being phased out; S56C is the recommended 140° HFOV model for new projects.
:::
...
| **Camera Support** | Astra S56 / S56C (depth), SHF3L (hand HDR 30fps), SHW3H (head HDR 60fps) |
...
| **Head Vision** | Astra S56C (depth+VLA), Astra S36 (optional), SHW3H (HDR 60fps) |
...
### <span style={{color: 'var(--ifm-color-primary)'}}>EgoSense H6 — Head-Mounted 6-Camera Data Collection Device</span>

**EgoSense H6** is SENSING's head-mounted, six-camera egocentric data collection device. It records first-person images, IMU and audio in sync, offline to an SD card.
...
See the [EgoSense H6 product page](/docs/6_3_Data_Collection_Device/EgoSense-H6).
...
|------------------|------------|------------|------------|-----------|
| Astra S56C (S56x Series, Binocular) | ★★★★★ (5MP) | ★★★★☆     | 140°       | IP52      |
