...
<div style={{background: 'var(--ifm-background-color)', borderRadius: '10px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', padding: '1.5rem', marginBottom: '2rem'}}>
  ...
  <div style={{textAlign: 'center', marginTop: '1.5rem'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_10_Humanoid_Robotic_Camera/Solutions/Robotic_Camera_Solutions.png?x-oss-process=image/format,webp" alt="CCG3-8M Application Scenario" style={{maxWidth: '100%', height:'auto', borderRadius: '8px'}} />
  </div>
</div>
...
*   **Head Vision**
    *   **Astra S56C:**  2 * 5MP Stereo Camera (Depth & VLA)
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Astra S56C** | Stereo | 2 * 5MP | Global | [140°/102°] | **Head**: Depth Sensing & SLAM | 1 | [View Specs](https://wiki.sensing-world.com/docs/6_1_Camera/Binocular_Camera/S56) |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Astra S56C** | Stereo | 2 * 5MP | Global | RAW | 140° | **Head**: Depth & VLA | 1 | [View Specs](https://wiki.sensing-world.com/docs/6_1_Camera/Binocular_Camera/S56) |
...
#### 8.1 Testing the Astra S56x Series (S56 / S56C, Stereo/RAW)
S56 and S56C connect via the RAW interface. Use `argus_camera` to view the stream.
...
argus_camera -d 1
```
<!-- > ![Astra S56x Series Sample Image](path/to/s56x_image.png) -->
<div style={{textAlign: 'center', marginTop: '1.5rem'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_10_Humanoid_Robotic_Camera/Solutions/bringUp_S56.png?x-oss-process=image/format,webp" alt="Astra S56x Series bring-up" style={{maxWidth: '85%', height:'auto', borderRadius: '8px'}} />
  </div>
