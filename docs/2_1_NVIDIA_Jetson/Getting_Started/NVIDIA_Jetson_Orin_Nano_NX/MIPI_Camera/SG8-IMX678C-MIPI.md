...
<div style={{textAlign: 'center'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_2_MIPI_CSI_Camera/SG8-IMX678C-MIPI/SG8-IMX678C-MIPI_Dimensions.png" alt="SG8-IMX678C-MIPI Dimensions" 
...
<div style={{textAlign: 'center'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_2_MIPI_CSI_Camera/SG8-IMX678C-MIPI/SG8-IMX678C-MIPI_Block_Diagram.png" alt="SG8-IMX678C-MIPI Block Diagram" 
    style={{maxWidth: '100%', height:'auto'}} />
</div>
