---
sidebar_position: 4
sidebar_label: SG12-IMX577C-MIPI (Discontinued)
---

# SG12-IMX577C-MIPI Camera

:::warning Product Discontinued (EOL)
**SG12-IMX577C-MIPI has been discontinued and is no longer available for purchase.** Its product page has been taken down from the SENSING website, so purchase links are no longer provided here.
...
<div style={{textAlign: 'center'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_2_MIPI_CSI_Camera/SG12-IMX577C-MIPI/SG12-IMX577C-MIPI_Dimensions.png" alt="SG12-IMX577C-MIPI Dimensions" 
...
<div style={{textAlign: 'center'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_2_MIPI_CSI_Camera/SG12-IMX577C-MIPI/SG12-IMX577C-MIPI_Block_Diagram.png" alt="SG12-IMX577C-MIPI Block Diagram" 
