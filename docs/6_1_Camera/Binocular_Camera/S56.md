---
sidebar_position: 1
title: Astra S56x Stereo Camera
---
...
<div className="row">
  <div className="col col--12">
    ...
    The module is equipped with a 6-axis IMU and boasts a human-like 60mm baseline. It integrates wide-angle lenses that provide 130° and 140° Horizontal Fields of View (HFOV).
  </div>
</div>
...
| **S56C Stereo Camera** | 140°±3° | 102°±3° | 2.0 | 2.67mm | 0.4~INF | 
...
<div style={{textAlign: 'center'}}>
    ...
    <p>S56x Stereo Camera Connect to Nvidia Jetson AGX Orin</p>
</div>
...
|-------------|-----------------|-------------|---------------|---------------|
| 1 | JP7.0 | S56x stereo camera | [TRD1 G2A](https://wiki.sensing-world.com/docs/2_4_NVIDIA_Jetson_AGX_Thor/Getting_Started/TRD1_G2A) | [Download](https://github.com/SENSING-Technology/nvidia-jetson-camera-drivers/tree/main/Jetson%20AGX%20Thor%20Devkit/TRD1_G2A/JetPack7.0/TRD1_G2A_AGX_THOR_GMSL2x8_JP7.0_L4TR38.2) |
