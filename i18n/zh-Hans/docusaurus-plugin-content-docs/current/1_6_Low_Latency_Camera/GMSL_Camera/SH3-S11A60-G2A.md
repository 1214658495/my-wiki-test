---
sidebar_position: 1
title: SH3-S11A60-G2A（60fps）
---

# SH3-S11A60-G2A（60fps）
...
#### 框图
<div style={{textAlign: 'center'}}>
 <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_6_Low_Latency_Camera/GMSL_Camera/SH3-S11A60-G2A_BlockDiagram.png" alt="SH3-S11A60-G2A"
 style={{maxWidth: '80%', height:'auto'}} />
</div>
...
<div style={{textAlign: 'center'}}>
 ...
 <p>SH3-S11A60-G2A 摄像头 连接到 NVIDIA Jetson AGX Orin</p>
</div>
