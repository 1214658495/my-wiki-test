...
**Astra S56C** 是 Astra S56x 系列当前的主推型号，专为嵌入式 AI 应用设计，采用双 5MP 全局曝光传感器，基线距离 60mm，接近人眼。
...
:::note Astra S56x 系列
Astra S56x 系列包含 S56 和 S56C。S56 是正在逐步停止销售的 130° HFOV 旧型号；S56C 是面向新项目主推的 140° HFOV 型号。
:::
...
| **摄像头支持** | Astra S56 / S56C (深度)、SHF3L (手部 HDR 30fps)、SHW3H (头部 HDR 60fps) |
...
| **头部视觉** | Astra S56C (深度+VLA)、Astra S36 (可选)、SHW3H (HDR 60fps) |
...
| 技术规格 | 参数 |
|------------------------|-------------|
| **相机** | 6 路（前置双目 + 左右侧各 2 路单目），1600 × 1300 |
| **快门** | 全局快门 |
| **组合视场角** | 270° |
| **帧率** | 30 fps（60 fps 可选） |
| **IMU** | 六轴，200 Hz |
| **存储 / 格式** | 256 GB Micro SD / `.mcap`（H.265） |
| **续航** | 约 3 小时 |
...
|------------------|------------|------------|------------|-----------|
| Astra S56C（S56x 系列，双目） | ★★★★★ (5MP) | ★★★★☆     | 140°       | IP52      |
