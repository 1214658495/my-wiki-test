...
**Astra S56** 是一款专为嵌入式 AI 应用设计的立体摄像头，采用双 5MP 全局快门传感器，基线距离60mm，接近人眼。
...
| **摄像头支持** | Astra S56 (深度)、SHF3L (手部 HDR 30fps)、SHW3H (头部 HDR 60fps) |
...
| **头部视觉** | Astra S56 (深度+VLA)、Astra S36 (可选)、SHW3H (HDR 60fps) |
