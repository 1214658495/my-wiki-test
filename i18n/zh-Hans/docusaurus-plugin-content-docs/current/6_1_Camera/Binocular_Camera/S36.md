...
<div style={{textAlign: 'center'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_10_Humanoid_Robotic_Camera/S36/S36_preview.png?x-oss-process=image/format,webp" alt="S36 双目摄像头"
...
<div style={{textAlign: 'center'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_10_Humanoid_Robotic_Camera/S36/S36_Dimensions.png?x-oss-process=image/format,webp" alt="S36 双目摄像头"
...
#### 框图
<div style={{textAlign: 'center'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_10_Humanoid_Robotic_Camera/S36/S36_BlockDiagram.png?x-oss-process=image/format,webp" alt="S36 双目摄像头框图"
    style={{maxWidth: '80%', height:'auto'}} />
</div>
:::note **IMU 配置说明**
...
<div style={{textAlign: 'center'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_10_Humanoid_Robotic_Camera/S36/S36_Application.jpg?x-oss-process=image/format,webp" alt="S36 双目摄像头连接到 NVIDIA Jetson AGX Orin"
