...
:::note 快速设置
1. 参考图片标注，使用同轴线将S56x双目摄像头连接到 TRD1 G2A 对应位置。
...
|-------------|-----------------|-------------|---------------|---------------|
| 1 | JP7.0 | S56x 双目摄像头 |[TRD1 G2A](https://wiki.sensing-world.com/zh-Hans/docs/2_4_NVIDIA_Jetson_AGX_Thor/Getting_Started/TRD1_G2A) | [下载](https://github.com/SENSING-Technology/nvidia-jetson-camera-drivers/tree/main/Jetson%20AGX%20Thor%20Devkit/TRD1_G2A/JetPack7.0/TRD1_G2A_AGX_THOR_GMSL2x8_JP7.0_L4TR38.2) |
