...
<div className="row">
  <div className="col col--12">
    S56S 双目摄像头是专为具身智能应用打造的摄像头模组，采用双 5MP 全局快门图像传感器，并基于高可靠性的 GMSL2 串行接口开发。
    该模组配备 6 轴 IMU，具备接近人眼的 60mm 基线，并集成宽角镜头，可提供 130° 水平视场角（HFOV）。
  </div>
</div>

<div style={{textAlign: 'center'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_10_Humanoid_Robotic_Camera/S56/S56_preview.png?x-oss-process=image/format,webp" alt="S56 Stereo Camera" 
...
<div style={{textAlign: 'center'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_10_Humanoid_Robotic_Camera/S56/S56_Dimensions.png?x-oss-process=image/format,webp" alt="S56 Stereo Camera" 
...
#### 框图
<div style={{textAlign: 'center'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_10_Humanoid_Robotic_Camera/S56/S56_BlockDiagram.png?x-oss-process=image/format,webp" alt="S56 Stereo Camera Block Diagram" 
    style={{maxWidth: '100%', height:'auto'}} />
</div>

:::note **IMU 配置说明**
IMU1: SCHA634-D03 (6-axis IMU)<br/>
IMU2: BMI088 (6-axis IMU)<br/>
...
<div style={{textAlign: 'center'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_10_Humanoid_Robotic_Camera/S56/S56_Application.jpg?x-oss-process=image/format,webp" alt="S56 Stereo Camera Connect to Nvidia Jetson AGX Orin" 
    style={{maxWidth: '60%', height:'auto'}} />
    <p>S56 双目摄像头连接到 NVIDIA Jetson AGX Orin</p>
</div>

#### **步骤 1**：安装步骤

:::note 快速设置
1. 使用同轴线将 S56 双目摄像头连接到 SG10A-AGON-G2M-A1 板卡
