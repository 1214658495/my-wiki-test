...
<div className="row">
  <div className="col col--12">
    SHW3H 摄像头专为具身智能应用打造，搭载具备高动态范围（HDR）和高帧率能力的 3MP 传感器。该摄像头面向机器人感知与识别进行优化，适合集成到人形机器人的头部或躯干。
    SHW3H 模组集成 RGGB 图像传感器与 Maxim GMSL2 串行器（MAX9295A），采用车规级传感器并搭配经过专业调校的图像信号处理器（ISP），可提供出色的图像质量。摄像头配备主动对准（AA）全玻璃广角镜头，具备 IP67 防护等级，并采用出厂定焦、全密封外壳。
  </div>
</div>
...
<div style={{textAlign: 'center'}}>
    ...
    <p>SHW3H 摄像头连接到 NVIDIA Jetson AGX Orin</p>
</div>
