...
<div className="row">
  <div className="col col--12">
    SHF3L 摄像头专为具身智能应用打造，搭载具备高动态范围（HDR）和高帧率能力的 3MP 传感器。该摄像头面向机器人感知与识别进行优化，适合集成到人形机器人的头部或躯干。
    SHF3L 模组集成 RGGB 图像传感器与 Maxim GMSL2 串行器（MAX9295A），采用车规级传感器并搭配经过专业调校的图像信号处理器（ISP），可提供出色的图像质量。摄像头配备主动对准（AA）全玻璃广角镜头，达到 IP67 防护等级，并采用出厂定焦、全密封外壳。
  </div>
</div>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>帧同步</td>
      <td>由 MAX9295A MFP7 控制</td>
    </tr>
    <tr>
      <td>复位</td>
      <td>由 MAX9295A MFP0 控制</td>
    </tr>
  </tbody>
</table>
...
<div style={{textAlign: 'center'}}>
    ...
    <p>SHF3L 摄像头连接到 NVIDIA Jetson AGX Orin</p>
</div>

#### **步骤 1**：安装步骤

:::note 快速设置
1. 使用同轴线将 SHF3L 摄像头连接到 SG10A-AGON-G2M-A1 板卡
