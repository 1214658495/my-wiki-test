...
:::note 概述
本兼容性矩阵列出了 SENSING GMSL 摄像头与各平台的适配关系，以及对应的系统版本要求。
:::
...
<div style={{
 ...
 <span>使用搜索框筛选摄像头，或双击表格获得更好的查看效果</span>
</div>
...
<div style={{
 ...
 <h3 style={{ marginTop: 0, fontSize: '1.2rem' }}>NVIDIA JetPack SDK 版本</h3>

 <p>NVIDIA JetPack 是 Jetson 平台的官方软件开发套件，提供操作系统、驱动、库和开发工具。</p>
