---
sidebar_position: 2
sidebar_label: SG2-IMX662C-MIPI（已下架）
---

# SG2-IMX662C-MIPI 摄像头

:::warning 产品已下架（停止销售）
**SG2-IMX662C-MIPI 已下架，不再对外销售。** 官网产品页面已下线，因此本页不再提供购买链接。
...
<div className="row">
 ...
 SG2-IMX662C-MIPI-HXXX 摄像头搭载 SONY IMX662 CMOS 图像传感器 (2.13MP), 出厂预对焦并配备 M12 镜头, 兼容多种 SOC 平台. 这款高性能摄像头可提供 1080p 分辨率、最高 60fps 帧率，并支持 HDR.
 </div>
</div>
...
| 参数 | 值 |
|-------------------|-------------------------|
| 型号 | SG2-IMX662C-MIPI-HXXX |
| 传感器 | SONY 2.13MP IMX662 RGGB |
| ISP | N/A |
| 传感器类型 | 卷帘快门 |
| 图像尺寸 | 1/2.8 inch CMOS |
| 输出分辨率 | 1920H×1080V |
| 帧率 | 最高 60 fps |
| 像元尺寸 | 2.9μm |
| HDR 支持 | 是 |
...
<div style={{textAlign: 'center'}}>
 <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_2_MIPI_CSI_Camera/SG2-IMX662C-MIPI/SG2-IMX662C-MIPI_Dimensions.png" alt="SG2-IMX662C-MIPI 尺寸"
...
<div style={{textAlign: 'center'}}>
 <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/1_0_Camera/1_2_MIPI_CSI_Camera/SG2-IMX662C-MIPI/SG2-IMX662C-MIPI_Block_Diagram.png" alt="SG2-IMX662C-MIPI 框图"
 style={{maxWidth: '100%', height:'auto'}} />
</div>
...
| 引脚 | 名称 | 类型 | 说明 |
|-----|------|------|-------------|
| 1 | E2PROM-WP | INPUT: 3.3V/1.8V | 写保护 用于 E2PROM<br/>L: 禁止写入; H: 允许写入 |
| 2 | / | N/C | 未连接 |
| 3 | / | N/C | 未连接 |
| 4 | GND | POWER | 地 |
| 5 | XHS | I/O: 1.8V | 水平同步发生器 |
| 6 | XVS | I/O: 1.8V | 垂直同步发生器 |
| 7 | GND | POWER | 地 |
...
| 22 | GND | POWER | 地 |
| 23 | SENSOR-RESET | INPUT: 1.8V | 传感器复位信号 |
| 24 | CAM-CLK | INPUT | 时钟信号输入 (24MHz)<br/>模组内置晶振 |
| 25 | GND | POWER | 地 |
| 26 | CAM-SCL | I/O: 3.3V | I2C 时钟 (上拉 10K) |
| 27 | CAM-SDA | I/O: 3.3V | I2C 数据 (上拉 10K) |
| 28 | GND | POWER | 地 |
...
:::info 上电要求
SG2-IMX662C-MIPI 摄像头对上电时序要求较少，只需确保电源稳定后再释放 RESET 信号。
:::
...
:::info 技术文档
《SG2-IMX662C-MIPI-HXXX 摄像头 数据手册》已不再通过官网提供下载。如需完整规格书和集成指南，请联系 SENSING 技术支持获取。
:::
...
| # | JetPack 版本 | 下载链接 |
|---|-----------------|---------------|
| 1 | JP5.1.2 (L4T R35.4.1) | [下载](https://github.com/SENSING-Technology/nvidia-jetson-camera-drivers/tree/main/Jetson%20Orin%20Nano%26NX%20Devkit/SG_MIPI_CAM/JetPack5.1.2/Jetson-Orin-Nano-DK_IMX662_JP5.1.2_L4TR35.4.1) |
| 2 | JP6.1 (L4T R36.4) | [下载](https://github.com/SENSING-Technology/nvidia-jetson-camera-drivers/tree/main/Jetson%20Orin%20Nano%26NX%20Devkit/SG_MIPI_CAM/JetPack6.1/Jetson-Orin-Nano-DK_IMX662_JP6.1_L4TR36.4.2) |
