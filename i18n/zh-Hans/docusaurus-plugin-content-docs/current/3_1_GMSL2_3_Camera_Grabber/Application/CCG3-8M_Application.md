...
<div style={{background: 'var(--ifm-background-color)', borderRadius: '10px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', padding: '1.5rem', marginBottom: '2rem'}}>
  ...
  <div style={{textAlign: 'center', marginTop: '1.5rem'}}>
    <img src="https://sgword-service.oss-cn-heyuan.aliyuncs.com/wiki-images/3_1_GMSL2_3_Camera_Grabber/CCG3-8M/CCG3-8M_useGround2.png" alt="CCG3-8M 应用场景" style={{maxWidth: '85%', height:'auto', borderRadius: '8px'}} />
  </div>
</div>
...
1. 使用 `FirmwareResources/` 目录中的对应文件重新烧录固件：
